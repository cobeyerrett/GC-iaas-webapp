...
function orchestration
{
	Param(
		...
		#[Parameter(Mandatory=$true)]
		[string]$subscriptionId = "60b6165a-8669-47a2-860c-6ef475127364",
		#[Parameter(Mandatory=$true)]
		[string]$resourceGroupName = "GCbluePrintUser1",
		#[Parameter(Mandatory=$true)]
		[string]$keyVaultName = "GCKeystoreUser1",
		#[Parameter(Mandatory=$true)]
		...
		#[Parameter(Mandatory=$true)]
		[string]$domain = "GCblueprint.local"
	)
